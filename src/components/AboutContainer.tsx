          ...
          <div className={styles.headingParent}>
            ...
            <div className={styles.omniRoyaleIsContainer}>
              <p className={styles.omniRoyaleIs}>
                ...
                rewriting the rules of web3 gaming. Powered by $OMNI, the first
                omnichain meme coin,
              </p>
              <p className={styles.omniRoyaleIs}>
                it brings an unprecedented level of cross-chain interaction to
                gaming.
              </p>
              <p className={styles.omniRoyaleIs}>&nbsp;</p>
              <p className={styles.omniRoyaleIs}>
                Brace yourself for adrenaline-pumping interchain showdowns,
                wager your skill with $OMNI, and emerge victorious in an epic
